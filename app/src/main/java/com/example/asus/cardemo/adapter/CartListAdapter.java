package com.example.asus.cardemo.adapter;
...
public class CartListAdapter extends RecyclerView.Adapter<CartListAdapter.MyViewHolder>{
    ...
    public CartListAdapter(List<CarBean.DataBean.ListBean> list, Context context) {
        this.list = list;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        MyViewHolder holder = new MyViewHolder(
                inflater.inflate(R.layout.item_shopping_cart_list, parent, false));
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                for (int i = 0; i < list.size(); i++) {
                    if (list.get(i).isCheck()) {
                        selectCount++;
                        total = Integer.parseInt(list.get(i).getBargainPrice()+"");
                    }
                }
        ...
        holder.amountView.setOnAmountChangeListener(new AmountView.OnAmountChangeListener() {
            ...
            public void onAmountChange(int amount) {
                ...
                if (onGartChangeListener != null) {
                    ...
                    int old_goods_total = Integer.parseInt(list.get(position).getBargainPrice()+"");;

                    int new_goods_total = old_goods_total / goods_num * amount;

                    list.get(position).setNum(Integer.parseInt(String.valueOf(amount)));
                    list.get(position).setBargainPrice(Double.parseDouble(new_goods_total + ".00"));
...
//
//                        presenter.DelGoodsToCart(
//                                sp.getString(UserInfo.KEY, ""), cart_id);
